...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-9a100a9643771618"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-9a100a9643771618",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-9a100a9643771618",
        "url": "https://en.wikipedia.org/wiki/Mahler_volume"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Mahler's conjecture on the product of the volumes of a centrally symmetric convex body and its polar .",
      "version": 1
    },
    "title": "Mahler's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "e5f92ce67102ad88d04dd5e853007c31657ec8680b877ca4b5fbb6690df1c34c"
}
```
